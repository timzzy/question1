...
// Images Directory
imagesDir = "myeditor/icons/";

// CSS Directory
cssDir = "myeditor/styles/";

// Popups Directory
popupsDir = "myeditor/popups/";
...
//	buttonName2[13]  = "seperator";
 ...
 // buttonName2[16]  = "help";
	buttonName2[17] = "unorderedlist";
	buttonName2[18] = "orderedlist";
	buttonName2[19] = "outdent";
	buttonName2[20] = "indent";
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC; background-color: #ffffff;"><tr><td valign="top">\n'
